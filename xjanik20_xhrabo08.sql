...
* Název:  IIS Projekt 1
* Autoøi: Roman Janík, Michal Hrabovský
...
INSERT INTO Student
VALUES(NULL, 'Kamil', 'Vachrlatý');
INSERT INTO Student
VALUES(NULL, 'Jan', 'Nejezchleba');
INSERT INTO Student
VALUES(NULL, 'Tomáš', 'Marný');
INSERT INTO Student
VALUES(NULL, 'Jarmil', 'Sychravý');
INSERT INTO Student
...
INSERT INTO Termin
VALUES(NULL, (STR_TO_DATE('16:18:14', '%H:%i:%s')), (STR_TO_DATE('20122112', '%Y%d%m')), 40, 2, 'Výteènì', (NOW()), 1, 1, 1);
INSERT INTO Termin
...
-- vypíše uèitele a pøedmìty, které uèí; slouží k zobrazení tabulky pøedmìtù a uèitelù
SELECT jmeno, prijmeni, nazev, zkratka
FROM Ucitel NATURAL JOIN UcitelPredmet NATURAL JOIN Predmet;

-- vypíše údaje o jednotlivých sezeních; slouží k zobrazení tabulky sezení s maximimálním poètem studentù na zkoušku
...
-- vybere studenty, kteøí nemají nenulové hodnocení (špatný prospìch); slouží k statistice studentù  
...
-- Dotaz spoèítá celkový dosažený poèet z otázek 1 termínu; v aplikaci se hodnota po odeslání hodnocení uèitelem uloží do položky p_dosaz_bodu v tabulce Termín
SELECT id_te, SUM(pocet_bodu) as bodu
FROM Otazka
GROUP BY id_te;
  
-- vypíše pøedmìty, které mají termín ve stejné datum; v aplikaci bude sloužit pro upozornìní uèitelù na kolizi datumù termínù zkoušek
...
-- Vypíše pøedmìty, které nemají zkoušku; v aplikaci bude sloužit k identifikaci pøedmìtù bez zkoušky
...
-- SQL 4. èást---------------------------------------------------------------------------------------------------
-- triggery
-- Pøi pokusu o vložení NULL hodnoty primárního klíèe vloží následující hodnotu sekvence
...
-- Seète poèty bodù z otázek patøících k 1 termínu vloží je do p_dosaz_bodu
...
-- materializovaný pohled pro druhého uživatele
